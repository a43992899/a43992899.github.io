...
PUBLICATION_MATCHERS = {
    ...
    "qwen3_omni": ["qwen3-omni technical report"],
    "qwen35_omni": ["qwen3. 5-omni technical report", "qwen3.5-omni technical report"],
    "kimi_audio": ["kimi-audio technical report"],
    "supergpqa": ["supergpqa:"],
    "spark_tts": ["spark-tts:"],
    "mmar": ["mmar: a challenging benchmark"],
    "foundation_models_music": ["foundation models for music:"],
    ...
    "audiox": ["audiox:", "a unified framework for anything-to-audio generation"],
    "audio_omni": ["audio-omni:"],
    "vidmuse": ["vidmuse:"],
    "uniss": ["uniss:"],
    "songformer": ["songformer:"],
    "voices_of_civilizations": ["voices of civilizations:"],
    "map_neo": ["map-neo:"],
    "map_music2vec": ["map-music2vec:"],
    "mert": ["mert: acoustic music understanding model"],
    "marble": ["marble: music audio representation benchmark"],
    "clamp2": ["clamp 2:"],
    "clamp3": ["clamp 3:"],
    "songeval": ["songeval:"],
    "editing_music": ["editing music with melody and text"],
